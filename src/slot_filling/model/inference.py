...
from src.slot_filling.model.utils import MODEL_CLASSES, load_tokenizer
import src.slot_filling.model.config as cfg
...
class SlotFillingInference:
    ...
    def load_model(self, model_path):
        ...
        if not os.path.exists(model_path):
            raise Exception('Model does not exists! Train first!')
