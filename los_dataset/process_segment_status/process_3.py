...
# Load dataframes
segment_df = pd.read_csv('los_dataset/dataset/temp_segments.csv', 
                            parse_dates=['created_at', 'updated_at'])                            
node_df = pd.read_csv('los_dataset/dataset/nodes.csv', index_col='_id')
...
df.set_index('_id').to_csv('los_dataset/dataset/segments.csv', index_label='_id')