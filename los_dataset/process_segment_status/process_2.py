...
segStatus_df = pd.read_csv('los_dataset/dataset/segment_reports.csv', index_col='_id', 
                            parse_dates=['updated_at'])
segment_df = pd.read_csv('los_dataset/dataset/temp_segments.csv', index_col='_id',
...
segStatus_df = segStatus_df.groupby(by=['segment_id', 'date', 'weekday', 'period'])['velocity'].apply(list)
...
segStatus_df['LOS'] = LOS

segStatus_df.to_csv('los_dataset/dataset/temp_segment_status.csv', index_label='_id')